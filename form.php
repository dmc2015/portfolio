...
<div class="text-center"id='frmFormMailContainer'>

<form class="" name="frmFormMail" id="frmFormMail" target="submitToFrame" action='<?php echo PHPFMG_ADMIN_URL . '' ; ?>' method='post' enctype='multipart/form-data' onsubmit='return fmgHandler.onSubmit(this);'>
...
<!-- HERE 2 INLINE RADIO BUTTONS -->
<li class='field_block inline' id='field_3_div'><div class='col_label'>
	<label class='form_field'>Type of Work</label> <label class='form_required' >*</label> </div>
	<div class='col_field'>
	<?php phpfmg_radios( 'field_3', "Freelance|Short-Term|Long-Term|Other", true );?>
